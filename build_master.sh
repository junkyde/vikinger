...
export CROSS_COMPILE=$PARENT_DIR/toolchains/linaro_4.7.4/bin/arm-gnueabi-
...
make VARIANT_DEFCONFIG=msm8930_serrano_$CARRIER"_defconfig" SELINUX_DEFCONFIG=selinux_defconfig SELINUX_LOG_DEFCONFIG=selinux_log_defconfig vikinger_defconfig

echo "Modding .config file - "$KTVER
sed -i 's,CONFIG_LOCALVERSION="-vikinger",CONFIG_LOCALVERSION="'$KTVER'",' .config
